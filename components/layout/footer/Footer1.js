                        ...
                        <div className="col-lg-4 col-md-12 text-center  d-none d-md-flex">
                            ...
                            <div className="d-inline-block">
                                <div className="header-logo mb-20">
                                    <h1 className="font-secondary"><Link className="text-white" href="/">Junaied</Link></h1>
                                    <p className="tagline font-primary">Creative Blogs</p>
                                </div>
                                <p className="site-des">Shantinagr, Dhaka, BD</p>
                                <p className="site-des">01781247234</p>
