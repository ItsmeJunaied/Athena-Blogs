                    ...
                    <div className="row align-items-center d-none d-md-flex">
                        ...
                        <div className="col-lg-2 col-md-4">
                            ...
                            <div className="header-logo text-center">
                                <h1 className="font-secondary"><Link href="/">Junaied</Link></h1>
                                <p className="tagline font-primary">Creative Blogs</p>
                            </div>
                        </div>
                        <div className="col-lg-5 col-md-4 text-end">
                            <div className="d-flex flex-end justify-content-end align-items-center">
                                ...
                                <div className="d-flex align-items-center">
                                    <Link className="social-icon text-xs-center mx-1 pt-1" target="_blank" href="https://www.facebook.com/junayed.hossain.921/?_rdr"><i className="ui-facebook-fill" /></Link>
                                    <Link className="social-icon text-xs-center mx-1 pt-1" target="_blank" href="https://www.facebook.com/junayed.hossain.921/?_rdr"><i className="ui-twitter-x-line" /></Link>
                                    <Link className="social-icon text-xs-center mx-1 pt-1" target="_blank" href="https://www.facebook.com/junayed.hossain.921/?_rdr"><i className="ui-pinterest-fill" /></Link>
                                    <Link className="social-icon text-xs-center mx-1 pt-1" target="_blank" href="https://www.facebook.com/junayed.hossain.921/?_rdr"><i className="ui-instagram-line" /></Link>
                                </div>
